...
import { themeColors } from '@/assets/data/data';
import { useStateContext } from '@/assets/contexts/contextProvider';

const ThemeSetting = () => {

    const { setColor, setMode, currentColor, currentMode, themeSettings, setThemeSettings } = useStateContext();

  return (
    <div className='top-0 right-0 bg-half-transparent w-screen fixed nav-item'>
        <div className='float-right h-screen dark:text-gray-200 bg-white dark:bg-secondary-dark-bg w-400 '>
            ...
            <div className='flex-col border-t-1 border-clor p-4 ml-4'>
